...
namespace BleakMod
{
    ...
    {   
        ...
        public static void Register()
        {
            ...
            string longDesc = "Changes each of the player's shots into two shots that fire in opposite directions, perpendicular to the player's cursor, and doubles all damage.\n\nYour elementary school teachers always told you that you wouldn't keep a protractor in your pocket everywhere you go. Prove them wrong.";
